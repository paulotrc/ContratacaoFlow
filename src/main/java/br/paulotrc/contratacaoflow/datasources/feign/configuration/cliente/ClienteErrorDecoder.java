...
public class ClienteErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        try {
            ...
            ResponseClienteData responseGerarCcb = objectMapper.readValue(body, ResponseClienteData.class);

            return new GatewayResourceIntegrationRuntimeException(
                    responseGerarCcb.getStatus().getErros().getMsgErro(),
                    responseGerarCcb.getStatus().getCodigo(),
